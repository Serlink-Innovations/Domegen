...
<div class="container mx-auto">
	...
	<form method="post" class="woocommerce-ResetPassword lost_reset_password" style="max-width: 55ch; margin: auto;">
		...
		<p class="woocommerce-form-row form-row">
			...
			<button type="submit"
				class="woocommerce-Button button btn btn-primary<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
